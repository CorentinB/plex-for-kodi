...
<control type="group" id="50">
    ...
    <control type="group" id="100">
        ...
        <control type="panel" id="101">
            <hitrect x="100" y="95" w="1700" h="1185" />
            <posx>100</posx>
            <posy>0</posy>
            <width>1700</width>
            <height>1198</height>
            ...
            <!-- ITEM LAYOUT ########################################## -->
            <itemlayout width="170" height="{{ vscale(270) }}">
                <control type="group">
                    <posx>5</posx>
            ...
            <!-- FOCUSED LAYOUT ####################################### -->
            <focusedlayout width="170" height="{{ vscale(270) }}">
                <control type="group">
                    <posx>5</posx>
                    <posy>{{ vscale(137) }}</posy>
                    <control type="group">
                        <animation effect="zoom" start="100" end="106" time="110" center="77,{{ vscale(223) }}" reversible="true" condition="Control.HasFocus(101)">Conditional</animation>
                        <posx>0</posx>
                        <posy>0</posy>
                        <control type="image">
                        ...
                        <control type="image">
                            ...
                            <posy>0</posy>
                            <width>154</width>
                            <height>{{ vscale(223) }}</height>
                            <texture>script.plex/poster-small-rounded-focus.png</texture>
                        </control>
                        <control type="group">
                            <posx>5</posx>
                            <posy>5</posy>
